...
const { getImport, createImport, createHousebl, viewImport, getNewHousebl, editImport, updateImport } = require("../controller/importController");
...
router.get("/import/:id/edit", setTitle("Edit House BL"), checkLogin, editImport); // Render edit import Page
router.post("/import/:id/edit", setTitle("Edit House BL"), checkLogin, updateImport); // Update Import data
